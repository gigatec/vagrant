...
echo "-- Configure PHP --"
sed -i "s/max_execution_time = .*/max_execution_time = 240/g" -i /etc/php5/apache2/php.ini
# /etc/php/7.0/apache2/php.ini
sed -i "s/; max_input_vars = .*/max_input_vars = 1500/g" -i /etc/php5/apache2/php.ini
...
cd /vagrant/public/
cp wp-config.php-vagrant wp-config.php
